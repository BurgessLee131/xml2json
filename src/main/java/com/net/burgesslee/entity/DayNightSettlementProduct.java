 ...
 */
public class DayNightSettlementProduct implements Serializable{
    /**
	 * 
	 */
	...
	public String toString() {
		return "DayNightSettlementProduct [unit=" + unit + ", project=" + project + ", dayWork=" + dayWork
				+ ", nightWork=" + nightWork + ", dayNightTotalWork=" + dayNightTotalWork
				+ ", monthCumulationProduction=" + monthCumulationProduction + ", qoq=" + qoq + ", yoy=" + yoy
				+ ", describe=" + describe + ", sort=" + sort + ", reportTime=" + reportTime + ", serialNumber="
				+ serialNumber + ", progressCompletion=" + progressCompletion + "]";
	}
}